...
<nav className=" dark:bg-gray-900 p-4 px-48  w-full text-md flex justify-between items-center  ">
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto " id="mobile-menu-language-select">
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto " id="mobile-menu-language-select">
    <div className="flex p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <Cart/>
        <Account/>
    </div>
  </div>
